    ...
    public class LoginController : Controller
    {
        ...
        public async Task<ActionResult> Login(DanhMucKhachHangDoiLenhLoginRequest model)
        {
            if (ModelState.IsValid)
            {
                ...
                {
                    client.BaseAddress = new Uri("http://192.168.1.56:90/api/DanhMucKhachHangDoiLenh/Login"); // Thay thế bằng URL API của bạn

                    // client.BaseAddress = new Uri("https://localhost:44304/api/DanhMucKhachHangDoiLenh/Login"); // Thay thế bằng URL API của bạn
        ...
        public async Task<ActionResult> Register(DanhMucKhachHangDoiLenhInsertRequest model)
        {
            if (ModelState.IsValid)
            {
                using (var client = new HttpClient())
                {
                    client.BaseAddress = new Uri("http://192.168.1.56:90/api/DanhMucKhachHangDoiLenh/Insert"); // Thay thế bằng URL API của bạn
                    var response = await client.PostAsJsonAsync(client.BaseAddress, model);
                    if (response.IsSuccessStatusCode)
                    {
...

                        {
                            ...
                            try
                            {
                                ...
                                message.To.Add(new MailboxAddress("Recipient Name", "kingbeeg123@gmail.com")); // Thay thế bằng email người nhận cố định
                                message.Subject = "Mã xác nhận tài khoản của bạn"; // Tiêu đề email cố định
                                message.Body = new TextPart("plain") { Text = $"Mã xác nhận của bạn là: {maKichHoat}" }; // Nội dung email cố định
        ...
        public async Task<ActionResult> ConfirmAccount(DanhMucKhachHangDoiLenhKichHoatRequest model)
        {
            if (ModelState.IsValid)
            {
                ...
                using (var client = new HttpClient())
                {
                    client.BaseAddress = new Uri("http://192.168.1.56:90/api/DanhMucKhachHangDoiLenh/UpdateKichHoat"); // Thay thế bằng URL API của bạn
        ...
        public async Task<ActionResult> getMaKichHoatByEmail(DanhMucKhachHangDoiLenhGetMaKichHoatByEmailRequest model)
        {
            if (ModelState.IsValid)
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    client.BaseAddress = new Uri("http://192.168.1.56:90/api/DanhMucKhachHangDoiLenh/getMaKichHoatByEmail"); // Replace with your main API URL
                    var response = await client.PostAsJsonAsync(client.BaseAddress, model);
        ...
        public async Task<ActionResult> GetMaXacNhanByEmail(DanhMucKhachHangDoiLenhGetMaXacNhanByEmailRequest model)
        {
            if (ModelState.IsValid)
            {
                ...
                using (var client = new HttpClient())
                {
                    ...
                    client.BaseAddress = new Uri("http://192.168.1.56:90/api/DanhMucKhachHangDoiLenh/getMaXacNhanByEmail"); // Replace with your main API URL
                    var response = await client.PostAsJsonAsync(client.BaseAddress, model);
        ...
        public async Task<ActionResult> XacNhanDoiMatKhau(DanhMucKhachHangDoiLenhXacNhanDoiMatKhauRequest model)
        {
            if (ModelState.IsValid)
            {
                ...
                using (var client = new HttpClient())
                {
                    client.BaseAddress = new Uri("http://192.168.1.56:90/api/DanhMucKhachHangDoiLenh/xacNhanDoiMatKhau"); // Thay thế bằng URL API của bạn
